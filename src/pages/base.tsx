...
const BaseColumn: NextPageWithLayout = () => {
  ...
  const bgIcon = (
    <svg width="100%" height="100%" viewBox="0 0 375 245" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <filter id="filter0_f_2081_5325" x="-54" y="0" width="483" height="245" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
  ...
  const logoIcon = (
    <svg width="126" height="126" viewBox="0 0 126 126" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path opacity="0.05" d="M62.8912 126C97.7493 126 126 97.7989 126 63C126 28.2011 97.7493 0 62.8912 0C29.8195 0 2.69108 25.3833 0 57.6965H83.4236V68.292H0C2.69108 100.617 29.8195 126 62.8912 126Z" fill="white" />
    </svg>
  )
