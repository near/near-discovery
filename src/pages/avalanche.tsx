  ...
  return (
    <Container>
      <div className="top">
        ...
        <p className="subTitle">Using Avalanche conveniently and efficiently</p>
      </div>
      <ComponentWrapperPage
        src={components.avalanche || ''}
        meta={{ title: 'Connect with the avalanche community.', description: 'Become part of the avalanche community.' }}
      />
    </Container>
  );
};
