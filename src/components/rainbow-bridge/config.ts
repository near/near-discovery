...
const tokenList = [
...

  {
    ...
    near_address: 'a0b86991c6218b36c1d19d4a2e9eb0ce3606eb48.factory.bridge.near',
  ...
  },
  {
    ...
    name: 'Dai Stablecoin',
    symbol: 'DAI',
    near_address: '6b175474e89094c44da98b954eedeac495271d0f.factory.bridge.near',
    decimals: 18,
  ...
  },
  {
    ...
    near_address: '2260fac5e5542a773aa44fbcfedf7c193bc2c599.factory.bridge.near',
  ...
  },
  {
    ...
    symbol: 'OCT',
    near_address: 'f5cfbc74057c610c8ef151a439252680ac68c6dc.factory.bridge.near',
    decimals: 18,
  ...
  },
  {
    ...
    near_address: '4691937a7508860f876c9c0a2a617e7d9e945d4b.factory.bridge.near',
...
const eNearAbi = [
  ...
  },
  {
    inputs: [],
    name: 'prover',
    outputs: [{ internalType: 'contract INearProver', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const ethClientAbi = [
  ...
  { inputs: [], name: 'adminReceiveEth', outputs: [], stateMutability: 'payable', type: 'function' },
  {
    inputs: [
      { internalType: 'address payable', name: 'destination', type: 'address' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'numBlockProducers', type: 'uint256' },
        ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'signatureIndex', type: 'uint256' }],
...
export { tokenList, lockerAbi, eNearAbi, custodianAbi, Erc20Abi, bridgeParams };
