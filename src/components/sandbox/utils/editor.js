import { DefaultEditorCode, DefaultEditorModuleCode, Filetype, StorageDomain, StorageType } from './const';
...
export const getSrcByNameOrPath = (nameOrPath, accountId, type) => {
  return nameOrPath.indexOf('/') >= 0 ? nameOrPath : `${accountId}/${type.toLocaleLowerCase()}/${nameOrPath}`;
};
