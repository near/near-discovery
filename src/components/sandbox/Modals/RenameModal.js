...
export default function RenameModal({ showModal, name, onRename, onHide }) {
  ...
  return (
    <Modal centered scrollable show={showModal === ModalTypes.RenameModal} onHide={onHide}>
      ...
      <Modal.Body>
        ...
        <input className="form-control" id="rename-input" type="text" value={newName} onChange={handleSetNewName} />
      </Modal.Body>
      <Modal.Footer>
        <button className="btn btn-success" disabled={!newName} onClick={handleConfirm}>
          Confirm
        </button>
