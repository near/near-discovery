  ...
  return (
    <div className={`d-flex justify-content-center min-vh-100`}>
      ...
      >
        ...
        <ButtonGetStarted className="outlined" onClick={() => setShowModal(ModalTypes.OpenModal)}>
          Open Component
        </ButtonGetStarted>
        <ButtonGetStarted onClick={() => handleNew(Filetype.Widget)}>Create New Component</ButtonGetStarted>
      </div>
    </div>
  );
};
