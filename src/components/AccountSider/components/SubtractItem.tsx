...
const twoSvg = (
  <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M18.3096 12.9755C18.3096 14.8228 17.3439 16.4296 15.9142 17.2883C18.6321 18.2805 20.6607 20.8938 20.9951 24.0683C21.0479 24.5671 20.6692 25 20.2034 25H6.79659C6.33081 25 5.95205 24.5671 6.00494 24.0683C6.34105 20.8725 8.39524 18.2449 11.1421 17.2669C9.72944 16.4047 8.77912 14.8068 8.77912 12.9755C8.77912 10.2268 10.9118 8 13.5444 8C16.1769 8 18.3096 10.2285 18.3096 12.9755ZM25.3114 15.6886H26.6886C27.413 15.6886 28 16.2756 28 17C28 17.7244 27.413 18.3114 26.6886 18.3114H25.3114V19.6886C25.3114 20.413 24.7244 21 24 21C23.2756 21 22.6886 20.413 22.6886 19.6886V18.3114H21.3114C20.587 18.3114 20 17.7244 20 17C20 16.2756 20.587 15.6886 21.3114 15.6886H22.6886V14.3114C22.6886 13.587 23.2756 13 24 13C24.7244 13 25.3114 13.587 25.3114 14.3114V15.6886Z" fill="#262836" />
    <defs>
      <linearGradient id="paint0_linear_7078_10077" x1="0.268401" y1="17" x2="29.2396" y2="23.772" gradientUnits="userSpaceOnUse">
        <stop stop-color="#62FFF6" />
        <stop offset="0.520833" stop-color="#B479FF" />
        <stop offset="1" stop-color="#FFC289" />
      </linearGradient>
...
const SubtractItem = ({ showInviteLink, setShowInviteLink }: { showInviteLink: boolean, setShowInviteLink: (show: boolean) => void }) => {
