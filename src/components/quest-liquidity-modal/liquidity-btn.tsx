...
//   // TODO
//   const [token0Bal, setToken0Bal] = useState(0);
...
//   const { token0, token1, decimals0, decimals1, id } = defaultPair;
//   const hypeAddress = addresses[id as keyof typeof addresses];
...
//     const token0Contract = new Contract(addresses[token0 as keyof typeof addresses], abi, provider);
...
//     const token1Contract = new Contract(addresses[token1 as keyof typeof addresses], abi, provider);
...
//     return '0';
//   };
//   const handleToken0Change = (amount: string) => {
//     setAmount0(amount);
//     if (Number(amount) === 0) {
//       setAmount1('');
...
//   const handleToken1Change = (amount: number) => {
//     setAmount1(amount);
//     if (Number(amount) === 0) {
//       setAmount0('');
//       setIsToken0Approved(true);
...
//     const tokenContract = new Contract(addresses[_token], abi, provider.getSigner());
...
//             <SwapButton>InSufficient Balance</SwapButton>
//           </div>
//         )}
//         {!isInSufficient &&
//           (isToken0Approved && isToken1Approved && !isToken0Approving && !isToken1Approving ? (
//             <div className="popup-swap-btn">
//               <SwapButton disabled={isLoading || !amount0 || !amount1} onClick={handleDeposit}>
...
//             <>
//               <div className="popup-swap-btn">
//                 <SwapButton disabled={isToken0Approved || isToken0Approving} onClick={() => handleApprove(true)}>
//                   {isToken0Approving ? (
//                     'loading..'
//                   ) : (
...
//                   )}
//                 </SwapButton>
//                 <SwapButton disabled={isToken1Approved || isToken1Approving} onClick={() => handleApprove(false)}>
//                   {isToken1Approving ? (
//                     'loading..'
//                   ) : (
//                     // <Spinner className="ph-bold ph-circle-notch" />
